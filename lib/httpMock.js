...
var randomWaitingTime = function(rule) {
  var meanValueFinal;
  var deviationValueFinal;

  if (rule) {
    meanValueFinal = rule.responseTimeInMilli;
    deviationValueFinal = rule.deviationValue;
  }

  if (meanValueFinal) {
    meanValueFinal = meanValue;
  }
  if (deviationValueFinal) {
    deviationValueFinal = deviationValue;
  }

  var result = random.get(meanValue, deviationValue);
